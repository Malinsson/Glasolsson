...
<div class="bg-white p-6 rounded shadow-md m-4">
    ...
    <form action="{{ route('categories.store')}}" method="POST" aria-label="Skapa kategori-formulär" class="flex flex-col gap-4 font-text">
        ...
        <button type="submit" aria-label="Skapa ny kategori" class="bg-slate-500 hover:bg-slate-700 text-white py-2 px-4 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">Skapa</button>
    </form>
